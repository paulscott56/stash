...
public class SomeExternalServiceAuthenticator implements ExternalServiceAuthenticator {
	...
	public AuthenticatedExternalWebService authenticate(String username, String password) {
		...
		// unsucessful authentication. For example BadCredentialsException

		// ...
		// ...

		// If authentication to external service succeeded then create
		// authenticated wrapper with proper Principal and GrantedAuthorities.
		// GrantedAuthorities may come from external service authentication or
		// be hardcoded at our layer as they are here with ROLE_DOMAIN_USER
